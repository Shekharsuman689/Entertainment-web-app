...

            {
                isAuthenticated ? <>
                    ...
                    <div className='flex flex-col gap-4'>
                        <div>No Account Found. Please Create Account </div>
                        <Link
                            to="/profile"
                            className="px-6 py-3 w-32 text-center bg-red-700 text-white font-semibold rounded-lg hover:bg-red-600 transition duration-300"
                        >
                            Visit Here
                        </Link>
                    </div>
